...
cdef class LogicMapping(LogicGroup):
    def __cinit__(self, *, str name, dict data=None, LogicGroup parent=None, dict contexts=None):
...
cdef class LogicSequence(LogicGroup):
    def __cinit__(self, *, str name, list data=None, LogicGroup parent=None, dict contexts=None):
        cdef object ctx_data
        if data is None:
            ctx_data = self.contexts.setdefault('data', [])
...
cdef class LogicGenerator(LogicGroup):
    def __cinit__(self, *, str name, object data=None, LogicGroup parent=None, dict contexts=None):
        if data is None:
