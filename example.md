# Example: Building a Trading Decision Tree

Below is a comprehensive example demonstrating how to build and use a decision tree for trading decisions using PyDecisionGraph.
...
## What this does
- Builds a decision tree for trading logic, with branches for opening, working, and closing positions.
- Demonstrates both Cython and Python API usage.
- Shows how to visualize the tree and its evaluation path using the web UI.
